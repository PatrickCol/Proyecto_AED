//
// Created by Patrick on 2/12/2024.
//

#ifndef PROYECTO_AED_FIBONACCI_HEAP_H
#define PROYECTO_AED_FIBONACCI_HEAP_H
...
void FHeap<T>::visualizar_heap(Nodo<T>* nodo, int nivel) {
    ...
    do {
        ...
        std::cout << "|__ Nodo: " << temp->data << " (rank: " << temp->rank << ")" << std::endl;
...
void FHeap<T>::visualizar() {
    std::cout << "Visualizacion del Fibonacci Heap:" << std::endl;
    if (rootlist == nullptr) {
...
#endif //PROYECTO_AED_FIBONACCI_HEAP_H
